...
export const BUFFER_FLUSH_SIZE = 5000;
export const PROGRESS_SAVE_INTERVAL = 20000;
export const PROGRESS_EMIT_INTERVAL = 5000;
export const DEFAULT_INDEX_BUILD_CONCURRENCY = 2;
export const MAX_INDEX_BUILD_CONCURRENCY = 4;
